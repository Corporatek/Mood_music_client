...
var getAllSongs = function getAllSongs() {
  return $.ajax({
...
var pl1Songs = function pl1Songs() {
  return $.ajax({
...
var pl2Songs = function pl2Songs() {
  return $.ajax({
...
var pl3Songs = function pl3Songs() {
  return $.ajax({
...
var pl4Songs = function pl4Songs() {
  return $.ajax({
...
var pl5Songs = function pl5Songs() {
  return $.ajax({
...
var newSong = function newSong(data) {
  return $.ajax({
    url: config.apiUrl + '/songs',
    method: 'POST',
    data: data
...
var showSongs = __webpack_require__(16);
var store = __webpack_require__(4);
var api = __webpack_require__(3);
var modal = __webpack_require__(10);
var playlist1 = __webpack_require__(33);
...
var addSongFailure = function addSongFailure(error) {
  alert('failed to add song', error);
};

var newSongSuccess = function newSongSuccess(data) {
...
var newSongFailure = function newSongFailure(error) {
  alert('failed to add song', error);
};
...
var getSongsSuccess = function getSongsSuccess(data) {
  ...
  var showSongsHtml = showSongs({ songs: data.songs });
...
var paydaySuccess = function paydaySuccess(data) {

  // console.log("it worked! ", data)
  // below takes the objects and turns them into html elements
  var showSongsHtml = playlist1({ songs: data.playlist.songs });

  // below appends all songs to the songs table on the front end
  $('table#payday').append('<tr>' + showSongsHtml + '</tr>');
};

var paydayFailure = function paydayFailure(error) {
  $('#message').text('Error getting songs');
  $('#message').css('background-color', 'red');
  //  console.log('Songs failed to load')
};

var vibesSuccess = function vibesSuccess(data) {
...
var vibesFailure = function vibesFailure(error) {
  $('#message').text('Error getting songs');
  $('#message').css('background-color', 'red');
  console.log('Songs failed to load');
};

var feelsSuccess = function feelsSuccess(data) {
...
var feelsFailure = function feelsFailure(error) {
  $('#message').text('Error getting songs');
  $('#message').css('background-color', 'red');
  // console.log('Songs failed to load')
};

var danceSuccess = function danceSuccess(data) {
...
var danceFailure = function danceFailure(error) {
  $('#message').text('Error getting songs');
  $('#message').css('background-color', 'red');
  // console.log('Songs failed to load')
};

var motivateSuccess = function motivateSuccess(data) {
...
var motivateFailure = function motivateFailure(error) {
  $('#message').text('Error getting songs');
  $('#message').css('background-color', 'red');
  // console.log('Songs failed to load')
};
...
var deleteSongFailure = function deleteSongFailure(error) {
...
module.exports = {
  ...
  paydaySuccess: paydaySuccess,
  paydayFailure: paydayFailure,
  vibesSuccess: vibesSuccess,
  vibesFailure: vibesFailure,
  feelsSuccess: feelsSuccess,
  feelsFailure: feelsFailure,
  danceFailure: danceFailure,
  danceSuccess: danceSuccess,
  motivateFailure: motivateFailure,
  motivateSuccess: motivateSuccess,
  deleteSongFailure: deleteSongFailure,
  deleteSongSuccess: deleteSongSuccess,
  newSongFailure: newSongFailure,
  newSongSuccess: newSongSuccess
};
/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(1)))
...
module.exports = (Handlebars["default"] || Handlebars).template({"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data) {
    return "<br>I'm a partial that is included every <big><i>songs</i></big> iteration\n";
},"useData":true});
...
var Modal = function () {
    function Modal() {
        ...
        var paydayPlaylist = document.createElement('button');
        ...
        var vibesPlaylist = document.createElement('button');
        ...
        var feelsPlaylist = document.createElement('button');
        ...
        var dancePlaylist = document.createElement('button');
        ...
        var motivatePlaylist = document.createElement('button');
...
// DELETE BUTTON
$('table').on('click', '.pl-delete-btn', function (event) {
...
// OPEN MODAL BUTTON
$('table').on('click', '.pl-btn', function (event) {
...
$('.add-song-btn').on('click', function (event) {
    ...
    var data = {
        ...
        addsong(data).then(ui.addSongSuccess).catch(ui.addSongFailure);
    };
    adding(data);
    m.close();
});
...
var addToPlaylist = function addToPlaylist(event) {
  event.preventDefault();
...
var getSongs = function getSongs(event) {
  // event.preventDefault()
  ...
  api.getAllSongs(data).then(ui.getSongsSuccess).catch(ui.getSongsFailure);
};

// APPEND ALL SONGS THAT BELONG TO PLAYLIST WITH ID "1"
var playlist1Songs = function playlist1Songs(event) {
  // event.preventDefault()
  // console.log('loading songs...')

  api.pl1Songs().then(ui.paydaySuccess).catch(ui.paydayFailure);
};

// APPEND ALL SONGS THAT BELONG TO PLAYLIST WITH ID "2"
var playlist2Songs = function playlist2Songs(event) {
  // event.preventDefault()
  // console.log('loading songs...')

  api.pl2Songs().then(ui.vibesSuccess).catch(ui.vibesFailure);
};

// APPEND ALL SONGS THAT BELONG TO PLAYLIST WITH ID "3"

var playlist3Songs = function playlist3Songs(event) {
  // event.preventDefault()
  // console.log('loading songs...')

  api.pl3Songs().then(ui.feelsSuccess).catch(ui.feelsFailure);
};

// APPEND ALL SONGS THAT BELONG TO PLAYLIST WITH ID "4"

var playlist4Songs = function playlist4Songs(event) {
  // event.preventDefault()
  // console.log('loading songs...')

  api.pl4Songs().then(ui.danceSuccess).catch(ui.danceFailure);
};

// APPEND ALL SONGS THAT BELONG TO PLAYLIST WITH ID "5"

var playlist5Songs = function playlist5Songs(event) {
  // event.preventDefault()
  // console.log('loading songs...')

  api.pl5Songs().then(ui.motivateSuccess).catch(ui.motivateFailure);
};

var songModal = function songModal(event) {
  event.preventDefault();
  // console.log('loading songs...')
...
var newSong = function newSong(event) {
  event.preventDefault();
  ...
  api.newSong(data).then(ui.newSongSuccess).catch(ui.newSongFailure);
};
...
var addHandlers = function addHandlers() {
  ...
  $('#chng-pw-btn').on('click', onChangePassword, function () {
    $('#change-password').css('display', 'block');
    $('#app').css('display', 'none');
  });
  $('#create-song').on('submit', newSong);

  $('button#payday-playlist').on('click', playlist1Songs, function () {
    $(document).ready(playlist1Songs);
  ...
  $('button#vibes-playlist').on('click', playlist2Songs, function () {
    $(document).ready(playlist2Songs);
    $('#playlists-app').css('display', 'block');
  ...
  $('button#motivate-playlist').on('click', playlist5Songs, function () {
    $(document).ready(playlist5Songs);
    $('#playlists-app').css('display', 'block');
  ...
  $('button#dance-playlist').on('click', playlist4Songs, function () {
    $(document).ready(playlist4Songs);
    $('#playlists-app').css('display', 'block');
  ...
  $('button#feels-playlist').on('click', playlist3Songs, function () {
    $(document).ready(playlist3Songs);
    $('#playlists-app').css('display', 'block');
...
var apiUrl = void 0;
var apiUrls = {
  production: 'https://blooming-beyond-64624.herokuapp.com',
...
module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data,blockParams) {
  ...
  return "  "
    ...
    + "\n  <!-- "
    + ((stack1 = container.invokePartial(__webpack_require__(9),depth0,{"name":"partial","data":data,"blockParams":blockParams,"helpers":helpers,"partials":partials,"decorators":container.decorators})) != null ? stack1 : "")
    + "\n  Don't uncomment yet -->\n\n <!-- Developers, why are we using data-id and not just id? -->\n  <tr data-id=\""
    + alias2(alias3(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
    + "\" src=\""
    + alias2(alias3(((stack1 = blockParams[0][0]) != null ? stack1.url : stack1), depth0))
    + "\">\n      <td class=\"song_id\" value=\""
    + alias2(alias3(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
    + "\"> "
    + ((stack1 = helpers["if"].call(alias1,((stack1 = blockParams[0][0]) != null ? stack1.id : stack1),{"name":"if","hash":{},"fn":container.program(2, data, 0, blockParams),"inverse":container.program(4, data, 0, blockParams),"data":data,"blockParams":blockParams})) != null ? stack1 : "")
    + "  </td>\n   <td class=\"title\" value=\""
    + alias2(alias3(((stack1 = blockParams[0][0]) != null ? stack1.title : stack1), depth0))
    + "\"> "
    + ((stack1 = helpers["if"].call(alias1,((stack1 = blockParams[0][0]) != null ? stack1.title : stack1),{"name":"if","hash":{},"fn":container.program(6, data, 0, blockParams),"inverse":container.program(8, data, 0, blockParams),"data":data,"blockParams":blockParams})) != null ? stack1 : "")
    + "  </td>\n   <td class=\"artist\"> "
    + ((stack1 = helpers["if"].call(alias1,((stack1 = blockParams[0][0]) != null ? stack1.artist : stack1),{"name":"if","hash":{},"fn":container.program(10, data, 0, blockParams),"inverse":container.program(12, data, 0, blockParams),"data":data,"blockParams":blockParams})) != null ? stack1 : "")
    + "  </td>\n   <td id=\"bpm\"> "
    + ((stack1 = helpers["if"].call(alias1,((stack1 = blockParams[0][0]) != null ? stack1.bpm : stack1),{"name":"if","hash":{},"fn":container.program(14, data, 0, blockParams),"inverse":container.program(16, data, 0, blockParams),"data":data,"blockParams":blockParams})) != null ? stack1 : "")
    + "  </td>\n   <td id=\"url\" value=\""
    + alias2(alias3(((stack1 = blockParams[0][0]) != null ? stack1.url : stack1), depth0))
    + "\"> "
    + ((stack1 = helpers["if"].call(alias1,((stack1 = blockParams[0][0]) != null ? stack1.url : stack1),{"name":"if","hash":{},"fn":container.program(18, data, 0, blockParams),"inverse":container.program(20, data, 0, blockParams),"data":data,"blockParams":blockParams})) != null ? stack1 : "")
    + "  </td>\n\n  <td><input class=\"pl-btn\" id=\"\" type=\"button\" data-toggle=\"modal\" value=\"Add to a playlist\"></td>\n  <!-- Button trigger modal -->\n\n\n<!-- Modal -->\n\n\n\n";
  ...
  return "\n      "
    + container.escapeExpression(container.lambda(((stack1 = blockParams[1][0]) != null ? stack1.artist : stack1), depth0))
    + "\n";
},"12":function(container,depth0,helpers,partials,data) {
    return "      No artist provided.\n  ";
},"14":function(container,depth0,helpers,partials,data,blockParams) {
    var stack1;

  return "\n      "
    + container.escapeExpression(container.lambda(((stack1 = blockParams[1][0]) != null ? stack1.bpm : stack1), depth0))
    + "\n";
},"16":function(container,depth0,helpers,partials,data) {
    return "      No bpm provided.\n  ";
},"18":function(container,depth0,helpers,partials,data,blockParams) {
    var stack1;

  return "\n      "
    + container.escapeExpression(container.lambda(((stack1 = blockParams[1][0]) != null ? stack1.url : stack1), depth0))
    + "\n";
  ...
  return ((stack1 = helpers.each.call(depth0 != null ? depth0 : (container.nullContext || {}),(depth0 != null ? depth0.songs : depth0),{"name":"each","hash":{},"fn":container.program(1, data, 1, blockParams),"inverse":container.noop,"data":data,"blockParams":blockParams})) != null ? stack1 : "");
...
module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data,blockParams) {
  ...
  return " "
    ...
    + "  </td>\n   <td class=\"artist\"> "
    + ((stack1 = helpers["if"].call(alias1,((stack1 = blockParams[0][0]) != null ? stack1.artist : stack1),{"name":"if","hash":{},"fn":container.program(6, data, 0, blockParams),"inverse":container.program(8, data, 0, blockParams),"data":data,"blockParams":blockParams})) != null ? stack1 : "")
    + "  </td>\n   <td id=\"bpm\"> "
    + ((stack1 = helpers["if"].call(alias1,((stack1 = blockParams[0][0]) != null ? stack1.bpm : stack1),{"name":"if","hash":{},"fn":container.program(10, data, 0, blockParams),"inverse":container.program(12, data, 0, blockParams),"data":data,"blockParams":blockParams})) != null ? stack1 : "")
    + "  </td>\n   <td id=\"url\" value=\""
    + alias2(alias3(((stack1 = blockParams[0][0]) != null ? stack1.url : stack1), depth0))
    + "\"> "
    + ((stack1 = helpers["if"].call(alias1,((stack1 = blockParams[0][0]) != null ? stack1.url : stack1),{"name":"if","hash":{},"fn":container.program(14, data, 0, blockParams),"inverse":container.program(16, data, 0, blockParams),"data":data,"blockParams":blockParams})) != null ? stack1 : "")
    + "  </td>\n\n  <td><input class=\"pl-delete-btn\" id=\"\" type=\"button\" value=\"Delete\"></td>\n  <!-- Button trigger modal -->\n\n\n<!-- Modal -->\n\n\n\n";
},"2":function(container,depth0,helpers,partials,data,blockParams) {
    var stack1;
